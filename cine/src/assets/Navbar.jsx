  ...
  return (
    <nav className="navbar">
      <div className="nav-left">
        <Link to="/" className="logo">🎬 CineScope</Link>
        <Link to="/">Home</Link>
